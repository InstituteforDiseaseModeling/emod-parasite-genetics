...
exp_name = f'FPG_longrun_MAF_{major_allele_frequency}_{minor_allele_frequency}_{var_gene_randomness}_{years_to_report}years_pop_scale_{population_scale_factor}'
...
cb = DTKConfigBuilder.from_files(config_name ='C:\git\emod-parasite-genetics\garki_long_run_genetic_behavior\inputs\config.json',
                                 campaign_name=f"C:\git\emod-parasite-genetics\garki_long_run_genetic_behavior\inputs\campaign_ParasiteGenetics_{major_allele_frequency}_{minor_allele_frequency}.json")

# cb = DTKConfigBuilder.from_defaults('MALARIA_SIM')

cb.update_params({
    "Demographics_Filenames": ["Garki_single_demographics_balanced_pop.json"],
    "Campaign_Filename": f"campaign_ParasiteGenetics_{major_allele_frequency}_{minor_allele_frequency}.json",
    ...
    "Parasite_Genetics": {
        ...
        "Var_Gene_Randomness_Type": var_gene_randomness,
    ...
    "x_Base_Population": population_scale_factor,
    "Base_Population_Scale_Factor":population_scale_factor,
...
#Reporting -----------------------------------------------------------------------------------------------------------
add_malaria_sql_report(cb,
                       include_health_table=0,
                       include_infection_data_table=1,
                       start_day=report_year*365,
                       end_day=years_to_report*365,
                       description='test'
                       )
