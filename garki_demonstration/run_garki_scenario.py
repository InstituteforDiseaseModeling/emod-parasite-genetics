...
exp_name = 'FPG_epi_validity_test_EnableSimilarityToBase'
# Setup ----------------------------------------------------------------------------------------------------------
# config_path = os.path.join('.', 'inputs','config.json')
cb = DTKConfigBuilder.from_files(config_name ='C:\git\emod-parasite-genetics\garki_demonstration\inputs\config.json', campaign_name="C:\git\emod-parasite-genetics\garki_demonstration\inputs\campaign_ParasiteGenetics.json")
