...
cb = DTKConfigBuilder.from_files(config_name ='C:\git\emod-parasite-genetics\garki_demonstration\inputs\config.json', campaign_name="C:\git\emod-parasite-genetics\garki_demonstration\inputs\campaign_Base.json")
