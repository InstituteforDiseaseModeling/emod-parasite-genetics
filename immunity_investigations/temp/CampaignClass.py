...
class CampaignEventByYear(BaseCampaign):
    ...
    def __init__(self, Event_Coordinator_Config=None, Nodeset_Config=None, Start_Year=1900, **kwargs):
...
class CommunityHealthWorkerEventCoordinator(BaseCampaign):
    _definition = {
        ...
        'Initial_Amount_Distribution': {
            ...
            'enum': ['NOT_INITIALIZED', 'CONSTANT_DISTRIBUTION', 'UNIFORM_DISTRIBUTION', 'GAUSSIAN_DISTRIBUTION', 'EXPONENTIAL_DISTRIBUTION', 'POISSON_DISTRIBUTION', 'LOG_NORMAL_DISTRIBUTION', 'DUAL_CONSTANT_DISTRIBUTION', 'WEIBULL_DISTRIBUTION', 'DUAL_EXPONENTIAL_DISTRIBUTION'],
            'type': 'enum',
        },
...
class IncidenceEventCoordinator(BaseCampaign):
    ...
    def __init__(self, Coordinator_Name='', Incidence_Counter=None, Number_Repetitions=1, Responder=None, Timesteps_Between_Repetitions=-1, **kwargs):
...
class NChooserEventCoordinator(BaseCampaign):
    ...
    def __init__(self, Distributions=None, Intervention_Config=None, **kwargs):
...
class ARTBasic(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=1, Days_To_Achieve_Viral_Suppression=183, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='ARTBasic', New_Property_Value=None, Sim_Types=['HIV_SIM', 'TBHIV_SIM'], Viral_Suppression=True, iv_type='IndividualTargeted', **kwargs):
...
class ARTDropout(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=1, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='ARTDropout', New_Property_Value=None, Sim_Types=['HIV_SIM', 'TBHIV_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class ActiveDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=ActiveDiagnostic_Event_Or_Config_Enum.Config, Intervention_Name='ActiveDiagnostic', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['TBHIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class AdherentDrug(BaseCampaign):
    ...
    def __init__(self, Adherence_Config=None, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Dose_Interval=1, Doses=None, Intervention_Name='AdherentDrug', Max_Dose_Consideration_Duration=3.40282e+38, New_Property_Value=None, Non_Adherence_Distribution=0, Non_Adherence_Options='NEXT_UPDATE', Sim_Types=['MALARIA_SIM'], Took_Dose_Event='', iv_type='IndividualTargeted', **kwargs):
...
class AntimalarialDrug(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Drug_Type='UNINITIALIZED STRING', Intervention_Name='AntimalarialDrug', New_Property_Value=None, Sim_Types=['MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class ArtificialDietHousingModification(BaseCampaign):
    ...
    def __init__(self, Blocking_Config=None, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='ArtificialDietHousingModification', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class BitingRisk(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='BitingRisk', New_Property_Value=None, Risk_Constant=6, Risk_Distribution=BitingRisk_Risk_Distribution_Enum.NOT_INITIALIZED, Risk_Exponential=6, Risk_Gaussian_Mean=6, Risk_Gaussian_Std_Dev=1, Risk_Kappa=1, Risk_Lambda=1, Risk_Log_Normal_Mu=6, Risk_Log_Normal_Sigma=1, Risk_Max=1, Risk_Mean_1=1, Risk_Mean_2=1, Risk_Min=0, Risk_Peak_2_Value=1, Risk_Poisson_Mean=6, Risk_Proportion_0=1, Risk_Proportion_1=1, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class BroadcastEvent(BaseCampaign):
    ...
    def __init__(self, Broadcast_Event='', Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='BroadcastEvent', New_Property_Value=None, Sim_Types=['*'], iv_type='IndividualTargeted', **kwargs):
...
class BroadcastEventToOtherNodes(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Event_Trigger='', Include_My_Node=False, Intervention_Name='BroadcastEventToOtherNodes', Max_Distance_To_Other_Nodes_Km=3.40282e+38, New_Property_Value=None, Node_Selection_Type=BroadcastEventToOtherNodes_Node_Selection_Type_Enum.DISTANCE_ONLY, Sim_Types=['*'], iv_type='IndividualTargeted', **kwargs):
...
class ControlledVaccine(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Distributed_Event_Trigger='', Dont_Allow_Duplicates=False, Duration_To_Wait_Before_Revaccination=3.40282e+38, Efficacy_Is_Multiplicative=True, Expired_Event_Trigger='', Intervention_Name='ControlledVaccine', New_Property_Value=None, Sim_Types=['*'], Vaccine_Take=1, Vaccine_Type=ControlledVaccine_Vaccine_Type_Enum.Generic, Waning_Config=[], iv_type='IndividualTargeted', **kwargs):
...
class DelayedIntervention(BaseCampaign):
    ...
    def __init__(self, Actual_IndividualIntervention_Configs=None, Coverage=1, Delay_Period_Constant=6, Delay_Period_Distribution=DelayedIntervention_Delay_Period_Distribution_Enum.NOT_INITIALIZED, Delay_Period_Exponential=6, Delay_Period_Gaussian_Mean=6, Delay_Period_Gaussian_Std_Dev=1, Delay_Period_Kappa=1, Delay_Period_Lambda=1, Delay_Period_Log_Normal_Mu=6, Delay_Period_Log_Normal_Sigma=1, Delay_Period_Max=1, Delay_Period_Mean_1=1, Delay_Period_Mean_2=1, Delay_Period_Min=0, Delay_Period_Peak_2_Value=1, Delay_Period_Poisson_Mean=6, Delay_Period_Proportion_0=1, Delay_Period_Proportion_1=1, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='DelayedIntervention', New_Property_Value=None, Sim_Types=['*'], iv_type='IndividualTargeted', **kwargs):
...
class HIVARTStagingByCD4Diagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, If_Active_TB=None, If_Pregnant=None, Individual_Property_Active_TB_Key='UNINITIALIZED', Individual_Property_Active_TB_Value='UNINITIALIZED', Intervention_Name='HIVARTStagingByCD4Diagnostic', Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['HIV_SIM'], Threshold=None, Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class HIVDelayedIntervention(BaseCampaign):
    ...
    def __init__(self, Broadcast_Event='', Broadcast_On_Expiration_Event='', Coverage=1, Delay_Period_Constant=6, Delay_Period_Distribution=HIVDelayedIntervention_Delay_Period_Distribution_Enum.NOT_INITIALIZED, Delay_Period_Exponential=6, Delay_Period_Gaussian_Mean=6, Delay_Period_Gaussian_Std_Dev=1, Delay_Period_Kappa=1, Delay_Period_Lambda=1, Delay_Period_Log_Normal_Mu=6, Delay_Period_Log_Normal_Sigma=1, Delay_Period_Max=1, Delay_Period_Mean_1=1, Delay_Period_Mean_2=1, Delay_Period_Min=0, Delay_Period_Peak_2_Value=1, Delay_Period_Poisson_Mean=6, Delay_Period_Proportion_0=1, Delay_Period_Proportion_1=1, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Expiration_Period=3.40282e+38, Intervention_Name='HIVDelayedIntervention', New_Property_Value=None, Sim_Types=['HIV_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class HIVDrawBlood(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Intervention_Name='HIVDrawBlood', Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['HIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class HIVMuxer(BaseCampaign):
    ...
    def __init__(self, Broadcast_Event='', Broadcast_On_Expiration_Event='', Coverage=1, Delay_Period_Constant=6, Delay_Period_Distribution=HIVMuxer_Delay_Period_Distribution_Enum.NOT_INITIALIZED, Delay_Period_Exponential=6, Delay_Period_Gaussian_Mean=6, Delay_Period_Gaussian_Std_Dev=1, Delay_Period_Kappa=1, Delay_Period_Lambda=1, Delay_Period_Log_Normal_Mu=6, Delay_Period_Log_Normal_Sigma=1, Delay_Period_Max=1, Delay_Period_Mean_1=1, Delay_Period_Mean_2=1, Delay_Period_Min=0, Delay_Period_Peak_2_Value=1, Delay_Period_Poisson_Mean=6, Delay_Period_Proportion_0=1, Delay_Period_Proportion_1=1, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Expiration_Period=3.40282e+38, Intervention_Name='HIVMuxer', Max_Entries=1, Muxer_Name='UNINITIALIZED STRING', New_Property_Value=None, Sim_Types=['HIV_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class HIVRandomChoice(BaseCampaign):
    _definition = {
        'Base_Sensitivity': {
            'default': 1,
            'description': 'The sensitivity of the diagnostic. This sets the proportion of the time that individuals with the condition being tested receive a positive diagnostic test. When set to zero, then individuals who have the condition always receive a false-negative diagnostic test.',
    ...
    _validator = ClassValidator(_definition, 'HIVRandomChoice')

    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Choice_Names=None, Choice_Probabilities=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Intervention_Name='HIVRandomChoice', Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['HIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
        super(HIVRandomChoice, self).__init__(**kwargs)
        self.Base_Sensitivity = Base_Sensitivity
        self.Base_Specificity = Base_Specificity
...
class HIVRapidHIVDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Intervention_Name='HIVRapidHIVDiagnostic', Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Probability_Received_Result=1, Sim_Types=['HIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class HIVSigmoidByYearAndSexDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Female_Multiplier=1, Intervention_Name='HIVSigmoidByYearAndSexDiagnostic', Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Ramp_Max=1, Ramp_MidYear=2000, Ramp_Min=0, Ramp_Rate=1, Sim_Types=['HIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class HIVSimpleDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Intervention_Name='HIVSimpleDiagnostic', Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['HIV_SIM', 'TBHIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class HealthSeekingBehaviorUpdate(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='HealthSeekingBehaviorUpdate', New_Property_Value=None, New_Tendency=1, Sim_Types=['TBHIV_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class HumanHostSeekingTrap(BaseCampaign):
    ...
    def __init__(self, Attract_Config=None, Cost_To_Consumer=3.75, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='HumanHostSeekingTrap', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class IRSHousingModification(BaseCampaign):
    _definition = {
        ...
        'Insecticide_Name': {
            ...
            'description': 'TBD',
            'type': 'Constrained String',
            'value_source': '<configuration>:Insecticides.Name',
        },
        'Intervention_Name': {
    ...
    def __init__(self, Blocking_Config=None, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='IRSHousingModification', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class IVCalendar(BaseCampaign):
    ...
    def __init__(self, Actual_IndividualIntervention_Configs=None, Calendar=[], Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Dropout=False, Intervention_Name='IVCalendar', New_Property_Value=None, Sim_Types=['*'], iv_type='IndividualTargeted', **kwargs):
...
class ImmunityBloodTest(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Intervention_Name='ImmunityBloodTest', Negative_Diagnosis_Config=None, Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Positive_Threshold_AcquisitionImmunity=1, Sim_Types=['*'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class InsectKillingFenceHousingModification(BaseCampaign):
    ...
    def __init__(self, Blocking_Config=None, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='InsectKillingFenceHousingModification', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class Ivermectin(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='Ivermectin', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class MalariaDiagnostic(BaseCampaign):
    _definition = {
        ...
        'Diagnostic_Type': {
            'default': 'BLOOD_SMEAR_PARASITES',
            'description': 'The type of malaria diagnostic used.',
            'enum': ['BLOOD_SMEAR_PARASITES', 'BLOOD_SMEAR_GAMETOCYTES', 'PCR_PARASITES', 'PCR_GAMETOCYTES', 'PF_HRP2', 'TRUE_PARASITE_DENSITY', 'FEVER'],
            'type': 'enum',
        },
        'Disqualifying_Properties': {
            'default': [],
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Detection_Threshold=0, Diagnostic_Type=MalariaDiagnostic_Diagnostic_Type_Enum.BLOOD_SMEAR_PARASITES, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=MalariaDiagnostic_Event_Or_Config_Enum.Config, Intervention_Name='MalariaDiagnostic', Measurement_Sensitivity=0.1, Negative_Diagnosis_Config=None, Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['MALARIA_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
        ...
        self.Event_Or_Config = (Event_Or_Config.name if isinstance(Event_Or_Config, Enum) else Event_Or_Config)
        self.Intervention_Name = Intervention_Name
        self.Measurement_Sensitivity = Measurement_Sensitivity
        self.Negative_Diagnosis_Config = Negative_Diagnosis_Config
        self.Negative_Diagnosis_Event = Negative_Diagnosis_Event
        self.New_Property_Value = New_Property_Value
        self.Positive_Diagnosis_Config = Positive_Diagnosis_Config
...
class MaleCircumcision(BaseCampaign):
    ...
    def __init__(self, Apply_If_Higher_Reduced_Acquire=False, Circumcision_Reduced_Acquire=0.6, Disqualifying_Properties=[], Distributed_Event_Trigger='', Dont_Allow_Duplicates=False, Intervention_Name='MaleCircumcision', New_Property_Value=None, Sim_Types=['STI_SIM', 'HIV_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class MigrateIndividuals(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Duration_At_Node_Constant=6, Duration_At_Node_Distribution=MigrateIndividuals_Duration_At_Node_Distribution_Enum.NOT_INITIALIZED, Duration_At_Node_Exponential=6, Duration_At_Node_Gaussian_Mean=6, Duration_At_Node_Gaussian_Std_Dev=1, Duration_At_Node_Kappa=1, Duration_At_Node_Lambda=1, Duration_At_Node_Log_Normal_Mu=6, Duration_At_Node_Log_Normal_Sigma=1, Duration_At_Node_Max=1, Duration_At_Node_Mean_1=1, Duration_At_Node_Mean_2=1, Duration_At_Node_Min=0, Duration_At_Node_Peak_2_Value=1, Duration_At_Node_Poisson_Mean=6, Duration_At_Node_Proportion_0=1, Duration_At_Node_Proportion_1=1, Duration_Before_Leaving_Constant=6, Duration_Before_Leaving_Distribution=MigrateIndividuals_Duration_Before_Leaving_Distribution_Enum.NOT_INITIALIZED, Duration_Before_Leaving_Exponential=6, Duration_Before_Leaving_Gaussian_Mean=6, Duration_Before_Leaving_Gaussian_Std_Dev=1, Duration_Before_Leaving_Kappa=1, Duration_Before_Leaving_Lambda=1, Duration_Before_Leaving_Log_Normal_Mu=6, Duration_Before_Leaving_Log_Normal_Sigma=1, Duration_Before_Leaving_Max=1, Duration_Before_Leaving_Mean_1=1, Duration_Before_Leaving_Mean_2=1, Duration_Before_Leaving_Min=0, Duration_Before_Leaving_Peak_2_Value=1, Duration_Before_Leaving_Poisson_Mean=6, Duration_Before_Leaving_Proportion_0=1, Duration_Before_Leaving_Proportion_1=1, Intervention_Name='MigrateIndividuals', Is_Moving=False, New_Property_Value=None, NodeID_To_Migrate_To=0, Sim_Types=['*'], iv_type='IndividualTargeted', **kwargs):
...
class MultiEffectBoosterVaccine(BaseCampaign):
    ...
    def __init__(self, Acquire_Config=None, Boost_Acquire=0, Boost_Mortality=0, Boost_Threshold_Acquire=0, Boost_Threshold_Mortality=0, Boost_Threshold_Transmit=0, Boost_Transmit=0, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='MultiEffectBoosterVaccine', Mortality_Config=None, New_Property_Value=None, Prime_Acquire=0, Prime_Mortality=0, Prime_Transmit=0, Sim_Types=['*'], Transmit_Config=None, Vaccine_Take=1, iv_type='IndividualTargeted', **kwargs):
...
class MultiEffectVaccine(BaseCampaign):
    ...
    def __init__(self, Acquire_Config=None, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='MultiEffectVaccine', Mortality_Config=None, New_Property_Value=None, Sim_Types=['*'], Transmit_Config=None, Vaccine_Take=1, iv_type='IndividualTargeted', **kwargs):
...
class MultiInsecticideIRSHousingModification(BaseCampaign):
    _definition = {
        'Cost_To_Consumer': {
            'default': 8,
            'description': 'Unit cost per housing modification (unamortized).',
        ...
        'Intervention_Name': {
            'default': 'MultiInsecticideIRSHousingModification',
            'description': 'The optional name used to refer to this intervention as a means to differentiate it from others that use the same class.',
            'type': 'string',
        },
        'New_Property_Value': {
    ...
    _validator = ClassValidator(_definition, 'MultiInsecticideIRSHousingModification')

    def __init__(self, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticides=None, Intervention_Name='MultiInsecticideIRSHousingModification', New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
        super(MultiInsecticideIRSHousingModification, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Disqualifying_Properties = Disqualifying_Properties
        self.Dont_Allow_Duplicates = Dont_Allow_Duplicates
...
class MultiInsecticideUsageDependentBednet(BaseCampaign):
    _definition = {
        'Cost_To_Consumer': {
            'default': 3.75,
    ...
    _validator = ClassValidator(_definition, 'MultiInsecticideUsageDependentBednet')

    def __init__(self, Cost_To_Consumer=3.75, Discard_Event='', Expiration_Period_Constant=6, Expiration_Period_Distribution=MultiInsecticideUsageDependentBednet_Expiration_Period_Distribution_Enum.NOT_INITIALIZED, Expiration_Period_Exponential=6, Expiration_Period_Gaussian_Mean=6, Expiration_Period_Gaussian_Std_Dev=1, Expiration_Period_Kappa=1, Expiration_Period_Lambda=1, Expiration_Period_Log_Normal_Mu=6, Expiration_Period_Log_Normal_Sigma=1, Expiration_Period_Max=1, Expiration_Period_Mean_1=1, Expiration_Period_Mean_2=1, Expiration_Period_Min=0, Expiration_Period_Peak_2_Value=1, Expiration_Period_Poisson_Mean=6, Expiration_Period_Proportion_0=1, Expiration_Period_Proportion_1=1, Insecticides=None, Received_Event='', Sim_Types=['MALARIA_SIM', 'VECTOR_SIM'], Usage_Config_List=[], Using_Event='', iv_type='IndividualTargeted', **kwargs):
        super(MultiInsecticideUsageDependentBednet, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
...
class MultiInterventionDistributor(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_List=None, Intervention_Name='MultiInterventionDistributor', New_Property_Value=None, Sim_Types=['*'], iv_type='IndividualTargeted', **kwargs):
...
class MultiPackComboDrug(BaseCampaign):
    _definition = {
        'Cost_To_Consumer': {
            'default': 10,
            'description': 'Unit cost per drug (unamortized).',
    ...
    _validator = ClassValidator(_definition, 'MultiPackComboDrug')

    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Dose_Interval=1, Doses=None, Intervention_Name='MultiPackComboDrug', New_Property_Value=None, Sim_Types=['MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
        super(MultiPackComboDrug, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Disqualifying_Properties = Disqualifying_Properties
        self.Dont_Allow_Duplicates = Dont_Allow_Duplicates
        self.Dose_Interval = Dose_Interval
...
class OutbreakIndividualMalaria(BaseCampaign):
    ...
    def __init__(self, Antigen=0, Create_Random_Genome=False, Genome_Markers=None, Ignore_Immunity=True, Incubation_Period_Override=-1, Sim_Types=['MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class OutbreakIndividualMalariaVarGenes(BaseCampaign):
    _definition = {
        'IRBC_Type': {
            'default': 0,
            'description': 'TBD',
    ...
    _validator = ClassValidator(_definition, 'OutbreakIndividualMalariaVarGenes')

    def __init__(self, IRBC_Type=0, Ignore_Immunity=True, Incubation_Period_Override=-1, MSP_Type=0, Minor_Epitope_Type=0, Non_Spec_Type=0, Sim_Types=['MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
        super(OutbreakIndividualMalariaVarGenes, self).__init__(**kwargs)
        self.IRBC_Type = IRBC_Type
        self.Ignore_Immunity = Ignore_Immunity
        self.Incubation_Period_Override = Incubation_Period_Override
        self.MSP_Type = MSP_Type
        self.Minor_Epitope_Type = Minor_Epitope_Type
        self.Non_Spec_Type = Non_Spec_Type
        self.Sim_Types = Sim_Types
        self.iv_type = iv_type
...
class PMTCT(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Efficacy=0.5, Intervention_Name='PMTCT', New_Property_Value=None, Sim_Types=['HIV_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class PolioVaccine(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Intervention_Name='PolioVaccine', New_Property_Value=None, Sim_Types=['POLIO_SIM'], Time_Since_Vaccination=0, Vaccine_Type=PolioVaccine_Vaccine_Type_Enum.tOPV, iv_type='IndividualTargeted', **kwargs):
...
class STIBarrier(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Early=1, Intervention_Name='STIBarrier', Late=1, MidYear=2000, New_Property_Value=None, Rate=1, Relationship_Type=STIBarrier_Relationship_Type_Enum.TRANSITORY, Sim_Types=['STI_SIM', 'HIV_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class STIIsPostDebut(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=STIIsPostDebut_Event_Or_Config_Enum.Config, Intervention_Name='STIIsPostDebut', Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['STI_SIM', 'HIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class ScreeningHousingModification(BaseCampaign):
    ...
    def __init__(self, Blocking_Config=None, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='ScreeningHousingModification', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class SimpleBednet(BaseCampaign):
    ...
    def __init__(self, Blocking_Config=None, Cost_To_Consumer=3.75, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='SimpleBednet', Killing_Config=None, New_Property_Value=None, Repelling_Config=None, Sim_Types=['MALARIA_SIM', 'VECTOR_SIM'], Usage_Config=None, iv_type='IndividualTargeted', **kwargs):
...
class SimpleBoosterVaccine(BaseCampaign):
    ...
    def __init__(self, Boost_Effect=1, Boost_Threshold=0, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Efficacy_Is_Multiplicative=True, Intervention_Name='SimpleBoosterVaccine', New_Property_Value=None, Prime_Effect=1, Sim_Types=['*'], Vaccine_Take=1, Vaccine_Type=SimpleBoosterVaccine_Vaccine_Type_Enum.Generic, Waning_Config=[], iv_type='IndividualTargeted', **kwargs):
...
class SimpleDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=SimpleDiagnostic_Event_Or_Config_Enum.Config, Intervention_Name='SimpleDiagnostic', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['*'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class SimpleHealthSeekingBehavior(BaseCampaign):
    ...
    def __init__(self, Actual_IndividualIntervention_Config=None, Actual_IndividualIntervention_Event='', Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Event_Or_Config=SimpleHealthSeekingBehavior_Event_Or_Config_Enum.Config, Intervention_Name='SimpleHealthSeekingBehavior', New_Property_Value=None, Sim_Types=['*'], Single_Use=True, Tendency=1, iv_type='IndividualTargeted', **kwargs):
...
class SimpleHousingModification(BaseCampaign):
    ...
    def __init__(self, Blocking_Config=None, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='SimpleHousingModification', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class SimpleIndividualRepellent(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='SimpleIndividualRepellent', New_Property_Value=None, Repelling_Config=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class SimpleVaccine(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Efficacy_Is_Multiplicative=True, Intervention_Name='SimpleVaccine', New_Property_Value=None, Sim_Types=['*'], Vaccine_Take=1, Vaccine_Type=SimpleVaccine_Vaccine_Type_Enum.Generic, Waning_Config=[], iv_type='IndividualTargeted', **kwargs):
...
class SmearDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=SmearDiagnostic_Event_Or_Config_Enum.Config, Intervention_Name='SmearDiagnostic', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['TBHIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class SpatialRepellentHousingModification(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=8, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='SpatialRepellentHousingModification', New_Property_Value=None, Repelling_Config=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class StandardDiagnostic(BaseCampaign):
    _definition = {
        'Base_Sensitivity': {
            'default': 1,
            'description': 'The sensitivity of the diagnostic. This sets the proportion of the time that individuals with the condition being tested receive a positive diagnostic test. When set to zero, then individuals who have the condition always receive a false-negative diagnostic test.',
    ...
    _validator = ClassValidator(_definition, 'StandardDiagnostic')

    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=StandardDiagnostic_Event_Or_Config_Enum.Config, Intervention_Name='StandardDiagnostic', Negative_Diagnosis_Config=None, Negative_Diagnosis_Event='', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['*'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
        super(StandardDiagnostic, self).__init__(**kwargs)
        self.Base_Sensitivity = Base_Sensitivity
        self.Base_Specificity = Base_Specificity
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Days_To_Diagnosis = Days_To_Diagnosis
...
class StiCoInfectionDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=StiCoInfectionDiagnostic_Event_Or_Config_Enum.Config, Intervention_Name='StiCoInfectionDiagnostic', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['STI_SIM', 'HIV_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class TBHIVConfigurableTBdrug(BaseCampaign):
    _definition = {
        ...
        'TB_Drug_Name': {
            ...
            'type': 'Constrained String',
            'value_source': '<configuration>:TBHIV_Drug_Params.*',
        },
...
class TyphoidCarrierDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Cost_To_Consumer=1, Days_To_Diagnosis=0, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Enable_IsSymptomatic=False, Event_Or_Config=TyphoidCarrierDiagnostic_Event_Or_Config_Enum.Config, Intervention_Name='TyphoidCarrierDiagnostic', New_Property_Value=None, Positive_Diagnosis_Config=None, Positive_Diagnosis_Event='', Sim_Types=['TYPHOID_SIM'], Treatment_Fraction=1, iv_type='IndividualTargeted', **kwargs):
...
class TyphoidVaccine(BaseCampaign):
    ...
    def __init__(self, Changing_Effect=None, Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Effect=1, Intervention_Name='TyphoidVaccine', Mode=TyphoidVaccine_Mode_Enum.Shedding, New_Property_Value=None, Sim_Types=['TYPHOID_SIM'], iv_type='IndividualTargeted', **kwargs):
...
class UsageDependentBednet(BaseCampaign):
    ...
    def __init__(self, Blocking_Config=None, Cost_To_Consumer=3.75, Discard_Event='', Disqualifying_Properties=[], Dont_Allow_Duplicates=False, Expiration_Period_Constant=6, Expiration_Period_Distribution=UsageDependentBednet_Expiration_Period_Distribution_Enum.NOT_INITIALIZED, Expiration_Period_Exponential=6, Expiration_Period_Gaussian_Mean=6, Expiration_Period_Gaussian_Std_Dev=1, Expiration_Period_Kappa=1, Expiration_Period_Lambda=1, Expiration_Period_Log_Normal_Mu=6, Expiration_Period_Log_Normal_Sigma=1, Expiration_Period_Max=1, Expiration_Period_Mean_1=1, Expiration_Period_Mean_2=1, Expiration_Period_Min=0, Expiration_Period_Peak_2_Value=1, Expiration_Period_Poisson_Mean=6, Expiration_Period_Proportion_0=1, Expiration_Period_Proportion_1=1, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='UsageDependentBednet', Killing_Config=None, New_Property_Value=None, Received_Event='', Repelling_Config=None, Sim_Types=['MALARIA_SIM', 'VECTOR_SIM'], Usage_Config_List=[], Using_Event='', iv_type='IndividualTargeted', **kwargs):
...
class AnimalFeedKill(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='AnimalFeedKill', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], iv_type='NodeTargeted', **kwargs):
...
class EnvironmentalDiagnostic(BaseCampaign):
    ...
    def __init__(self, Base_Sensitivity=1, Base_Specificity=1, Disqualifying_Properties=[], Environment_IP_Key_Value=None, Intervention_Name='EnvironmentalDiagnostic', Negative_Diagnostic_Event='', New_Property_Value=None, Positive_Diagnostic_Event='', Sample_Threshold=0, Sim_Types=['ENVIRONMENTAL_SIM', 'TYPHOID_SIM'], iv_type='NodeTargeted', **kwargs):
...
class ImportPressure(BaseCampaign):
    ...
    def __init__(self, Antigen=0, Daily_Import_Pressures=0, Durations=1, Genome=0, Import_Age=365, Incubation_Period_Override=-1, Number_Cases_Per_Node=1, Probability_Of_Infection=1, Sim_Types=['GENERIC_SIM'], iv_type='NodeTargeted', **kwargs):
...
class IndoorSpaceSpraying(BaseCampaign):
    _definition = {
        'Cost_To_Consumer': {
            'default': 10,
            'description': 'Unit cost per vector control (unamortized).',
    ...
    _validator = ClassValidator(_definition, 'IndoorSpaceSpraying')

    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='IndoorSpaceSpraying', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], Spray_Coverage=1, iv_type='NodeTargeted', **kwargs):
        super(IndoorSpaceSpraying, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Disqualifying_Properties = Disqualifying_Properties
        self.Insecticide_Name = Insecticide_Name
        self.Intervention_Name = Intervention_Name
        ...
        self.New_Property_Value = New_Property_Value
        self.Sim_Types = Sim_Types
        self.Spray_Coverage = Spray_Coverage
        self.iv_type = iv_type
...
class InsectKillingFence(BaseCampaign):
    _definition = {
        ...
        'Killing_Config': {
            'description': 'TBD-The configuration for the effects of killing of the targeted stage. Use a waning effect class to specify how this effect decays over time.',
            'type': 'idmType:WaningEffect',
        },
        'New_Property_Value': {
            'description': 'An optional NodeProperty key:value pair that will be assigned when the intervention is distributed. Generally used to indicate the broad category of health care cascade to which an intervention belongs to prevent individuals from accessing care through multiple pathways.',
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Intervention_Name='InsectKillingFence', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], iv_type='NodeTargeted', **kwargs):
...
class Larvicides(BaseCampaign):
    _definition = {
        ...
        'Larval_Killing_Config': {
            'description': 'The configuration of larval killing and waning for targeted stage.',
            'type': 'idmType:WaningEffect',
        },
        'New_Property_Value': {
            'description': 'An optional NodeProperty key:value pair that will be assigned when the intervention is distributed. Generally used to indicate the broad category of health care cascade to which an intervention belongs to prevent individuals from accessing care through multiple pathways.',
        ...
        'Spray_Coverage': {
            'default': 1,
            'description': 'TBD-The portion of the node that has been sprayed.',
            'max': 1,
            'min': 0,
            'type': 'float',
        },
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Habitat_Target=Larvicides_Habitat_Target_Enum.TEMPORARY_RAINFALL, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='Larvicides', Larval_Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], Spray_Coverage=1, iv_type='NodeTargeted', **kwargs):
        ...
        self.Insecticide_Name = Insecticide_Name
        self.Intervention_Name = Intervention_Name
        self.Larval_Killing_Config = Larval_Killing_Config
        self.New_Property_Value = New_Property_Value
        self.Sim_Types = Sim_Types
        self.Spray_Coverage = Spray_Coverage
        self.iv_type = iv_type
...
class MigrateFamily(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Duration_At_Node_Constant=6, Duration_At_Node_Distribution=MigrateFamily_Duration_At_Node_Distribution_Enum.NOT_INITIALIZED, Duration_At_Node_Exponential=6, Duration_At_Node_Gaussian_Mean=6, Duration_At_Node_Gaussian_Std_Dev=1, Duration_At_Node_Kappa=1, Duration_At_Node_Lambda=1, Duration_At_Node_Log_Normal_Mu=6, Duration_At_Node_Log_Normal_Sigma=1, Duration_At_Node_Max=1, Duration_At_Node_Mean_1=1, Duration_At_Node_Mean_2=1, Duration_At_Node_Min=0, Duration_At_Node_Peak_2_Value=1, Duration_At_Node_Poisson_Mean=6, Duration_At_Node_Proportion_0=1, Duration_At_Node_Proportion_1=1, Duration_Before_Leaving_Constant=6, Duration_Before_Leaving_Distribution=MigrateFamily_Duration_Before_Leaving_Distribution_Enum.NOT_INITIALIZED, Duration_Before_Leaving_Exponential=6, Duration_Before_Leaving_Gaussian_Mean=6, Duration_Before_Leaving_Gaussian_Std_Dev=1, Duration_Before_Leaving_Kappa=1, Duration_Before_Leaving_Lambda=1, Duration_Before_Leaving_Log_Normal_Mu=6, Duration_Before_Leaving_Log_Normal_Sigma=1, Duration_Before_Leaving_Max=1, Duration_Before_Leaving_Mean_1=1, Duration_Before_Leaving_Mean_2=1, Duration_Before_Leaving_Min=0, Duration_Before_Leaving_Peak_2_Value=1, Duration_Before_Leaving_Poisson_Mean=6, Duration_Before_Leaving_Proportion_0=1, Duration_Before_Leaving_Proportion_1=1, Intervention_Name='MigrateFamily', Is_Moving=False, New_Property_Value=None, NodeID_To_Migrate_To=0, Sim_Types=['*'], iv_type='NodeTargeted', **kwargs):
...
class MosquitoRelease(BaseCampaign):
    _definition = {
        ...
        'Released_Genome': {
            'description': 'TBD-The genetic makeup of the release mosquitos.',
            'type': 'Vector 2d String',
            'value_source': '<configuration>:Vector_Species_Params.*Genes.*',
        },
        'Released_Number': {
            'default': 10000,
        ...
        'Released_Wolbachia': {
            'default': 'VECTOR_WOLBACHIA_FREE',
            'description': 'The Wolbachia type of released mosquitoes.',
            'enum': ['VECTOR_WOLBACHIA_FREE', 'VECTOR_WOLBACHIA_A', 'VECTOR_WOLBACHIA_B', 'VECTOR_WOLBACHIA_AB'],
            'type': 'enum',
        },
        'Sim_Types': ['VECTOR_SIM', 'MALARIA_SIM'],
    ...
    def __init__(self, Cost_To_Consumer=0, Disqualifying_Properties=[], Intervention_Name='MosquitoRelease', New_Property_Value=None, Released_Genome=None, Released_Number=10000, Released_Species='UNINITIALIZED STRING', Released_Wolbachia=MosquitoRelease_Released_Wolbachia_Enum.VECTOR_WOLBACHIA_FREE, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM'], iv_type='NodeTargeted', **kwargs):
        super(MosquitoRelease, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Disqualifying_Properties = Disqualifying_Properties
        self.Intervention_Name = Intervention_Name
        self.New_Property_Value = New_Property_Value
        self.Released_Genome = Released_Genome
...
class MultiInsecticideIndoorSpaceSpraying(BaseCampaign):
    _definition = {
        'Cost_To_Consumer': {
            'default': 10,
            'description': 'Unit cost per vector control (unamortized).',
    ...
    _validator = ClassValidator(_definition, 'MultiInsecticideIndoorSpaceSpraying')

    def __init__(self, Cost_To_Consumer=10, Insecticides=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], Spray_Coverage=1, iv_type='NodeTargeted', **kwargs):
        super(MultiInsecticideIndoorSpaceSpraying, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Insecticides = Insecticides
        self.Sim_Types = Sim_Types
        self.Spray_Coverage = Spray_Coverage
...
class MultiInsecticideSpaceSpraying(BaseCampaign):
    _definition = {
        'Cost_To_Consumer': {
            'default': 10,
            'description': 'Unit cost per vector control (unamortized).',
        ...
        'Spray_Kill_Target': {
            ...
            'enum': ['SpaceSpray_FemalesOnly', 'SpaceSpray_MalesOnly', 'SpaceSpray_FemalesAndMales'],
            'type': 'enum',
        },
        'class': 'MultiInsecticideSpaceSpraying',
        'iv_type': 'NodeTargeted',
    }
    _validator = ClassValidator(_definition, 'MultiInsecticideSpaceSpraying')

    def __init__(self, Cost_To_Consumer=10, Insecticides=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], Spray_Coverage=1, Spray_Kill_Target=MultiInsecticideSpaceSpraying_Spray_Kill_Target_Enum.SpaceSpray_FemalesOnly, iv_type='NodeTargeted', **kwargs):
        super(MultiInsecticideSpaceSpraying, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Insecticides = Insecticides
        self.Sim_Types = Sim_Types
        self.Spray_Coverage = Spray_Coverage
...
class MultiNodeInterventionDistributor(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Intervention_Name='MultiNodeInterventionDistributor', New_Property_Value=None, Node_Intervention_List=None, Sim_Types=['*'], iv_type='NodeTargeted', **kwargs):
...
class NodePropertyValueChanger(BaseCampaign):
    ...
    def __init__(self, Daily_Probability=1, Disqualifying_Properties=[], Intervention_Name='NodePropertyValueChanger', Maximum_Duration=3.40282e+38, New_Property_Value=None, Revert=0, Sim_Types=['*'], Target_NP_Key_Value=None, iv_type='NodeTargeted', **kwargs):
...
class OutdoorRestKill(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='OutdoorRestKill', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], iv_type='NodeTargeted', **kwargs):
...
class OvipositionTrap(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Habitat_Target=OvipositionTrap_Habitat_Target_Enum.TEMPORARY_RAINFALL, Intervention_Name='OvipositionTrap', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], iv_type='NodeTargeted', **kwargs):
...
class PolioNodeSurvey(BaseCampaign):
    ...
    def __init__(self, Disqualifying_Properties=[], Intervention_Name='PolioNodeSurvey', New_Property_Value=None, Sim_Types=['POLIO_SIM'], iv_type='NodeTargeted', **kwargs):
...
class ScaleLarvalHabitat(BaseCampaign):
    _definition = {
        ...
        'Larval_Habitat_Multiplier': {
            ...
            'LarvalHabitatMultiplier': {
                'description': 'The value by which to scale the larval habitat availability specified in the configuration file with Larval_Habitat_Types across all habitat types, for specific habitat types, or for specific mosquito species within each habitat type.',
                'LarvalHabitatMultiplierSpec_Value': {
                    'Factor': {
                        'default': 1,
    ...
    def __init__(self, Disqualifying_Properties=[], Intervention_Name='ScaleLarvalHabitat', Larval_Habitat_Multiplier=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], iv_type='NodeTargeted', **kwargs):
...
class SpaceSpraying(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='SpaceSpraying', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], Spray_Coverage=1, Spray_Kill_Target=SpaceSpraying_Spray_Kill_Target_Enum.SpaceSpray_FemalesOnly, iv_type='NodeTargeted', **kwargs):
...
class SpatialRepellent(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='SpatialRepellent', New_Property_Value=None, Repelling_Config=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], iv_type='NodeTargeted', **kwargs):
...
class SugarTrap(BaseCampaign):
    ...
    def __init__(self, Cost_To_Consumer=10, Disqualifying_Properties=[], Expiration_Constant=6, Expiration_Distribution=SugarTrap_Expiration_Distribution_Enum.NOT_INITIALIZED, Expiration_Exponential=6, Expiration_Gaussian_Mean=6, Expiration_Gaussian_Std_Dev=1, Expiration_Kappa=1, Expiration_Lambda=1, Expiration_Log_Normal_Mu=6, Expiration_Log_Normal_Sigma=1, Expiration_Max=1, Expiration_Mean_1=1, Expiration_Mean_2=1, Expiration_Min=0, Expiration_Peak_2_Value=1, Expiration_Poisson_Mean=6, Expiration_Proportion_0=1, Expiration_Proportion_1=1, Insecticide_Name='UNINITIALIZED STRING', Intervention_Name='SugarTrap', Killing_Config=None, New_Property_Value=None, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], iv_type='NodeTargeted', **kwargs):
        super(SugarTrap, self).__init__(**kwargs)
        self.Cost_To_Consumer = Cost_To_Consumer
        self.Disqualifying_Properties = Disqualifying_Properties
        self.Expiration_Constant = Expiration_Constant
        self.Expiration_Distribution = (Expiration_Distribution.name if isinstance(Expiration_Distribution, Enum) else Expiration_Distribution)
        self.Expiration_Exponential = Expiration_Exponential
        self.Expiration_Gaussian_Mean = Expiration_Gaussian_Mean
        self.Expiration_Gaussian_Std_Dev = Expiration_Gaussian_Std_Dev
        self.Expiration_Kappa = Expiration_Kappa
        self.Expiration_Lambda = Expiration_Lambda
        self.Expiration_Log_Normal_Mu = Expiration_Log_Normal_Mu
        self.Expiration_Log_Normal_Sigma = Expiration_Log_Normal_Sigma
        self.Expiration_Max = Expiration_Max
        self.Expiration_Mean_1 = Expiration_Mean_1
        self.Expiration_Mean_2 = Expiration_Mean_2
        self.Expiration_Min = Expiration_Min
        self.Expiration_Peak_2_Value = Expiration_Peak_2_Value
        self.Expiration_Poisson_Mean = Expiration_Poisson_Mean
        self.Expiration_Proportion_0 = Expiration_Proportion_0
        self.Expiration_Proportion_1 = Expiration_Proportion_1
        self.Insecticide_Name = Insecticide_Name
        self.Intervention_Name = Intervention_Name
        self.Killing_Config = Killing_Config
        self.New_Property_Value = New_Property_Value
...
class TyphoidWASH(BaseCampaign):
    ...
    def __init__(self, Changing_Effect=None, Disqualifying_Properties=[], Effect=1, Intervention_Name='TyphoidWASH', Mode=TyphoidWASH_Mode_Enum.Shedding, New_Property_Value=None, Sim_Types=['TYPHOID_SIM'], Targeted_Individual_Properties='default', Use_Property_Targeting=True, iv_type='NodeTargeted', **kwargs):
...
class MalariaImmunityReport(BaseCampaign):
    _definition = {
        'Age_Bins': {
            'ascending': 1,
            'default': 0,
            'description': 'Age Bins (in years) to aggregate within and report',
            'max': 125,
            'min': 0,
            'type': 'Vector Float',
        },
        'Duration_Days': {
            'default': 3.40282e+38,
            'description': 'Used by reports and custom reports. The number of days over which to report events.',
            'max': 3.40282e+38,
            'min': 0,
            'type': 'float',
        },
        'Event_Trigger_List': {
            'Built-in': ['Births', 'EveryUpdate', 'EveryTimeStep', 'NewInfectionEvent', 'TBActivation', 'NewClinicalCase', 'NewSevereCase', 'DiseaseDeaths', 'OpportunisticInfectionDeath', 'NonDiseaseDeaths', 'TBActivationSmearPos', 'TBActivationSmearNeg', 'TBActivationExtrapulm', 'TBActivationPostRelapse', 'TBPendingRelapse', 'TBActivationPresymptomatic', 'TestPositiveOnSmear', 'ProviderOrdersTBTest', 'TBTestPositive', 'TBTestNegative', 'TBTestDefault', 'TBRestartHSB', 'TBMDRTestPositive', 'TBMDRTestNegative', 'TBMDRTestDefault', 'TBFailedDrugRegimen', 'TBRelapseAfterDrugRegimen', 'TBStartDrugRegimen', 'TBStopDrugRegimen', 'PropertyChange', 'STIDebut', 'StartedART', 'StoppedART', 'InterventionDisqualified', 'HIVNewlyDiagnosed', 'GaveBirth', 'Pregnant', 'Emigrating', 'Immigrating', 'HIVTestedNegative', 'HIVTestedPositive', 'NewlySymptomatic', 'SymptomaticCleared', 'TwelveWeeksPregnant', 'FourteenWeeksPregnant', 'SixWeeksOld', 'EighteenMonthsOld', 'STIPreEmigrating', 'STIPostImmigrating', 'STINewInfection', 'NewExternalHIVInfection', 'NodePropertyChange', 'HappyBirthday', 'EnteredRelationship', 'ExitedRelationship', 'FirstCoitalAct', 'ExposureComplete', 'VectorToHumanTransmission', 'HumanToVectorTransmission'],
            'default': '',
            'description': 'Used by reports and custom reports. The list of triggers for the events included in the report.',
            'type': 'Vector String',
            'value_source': "'<configuration>:Custom_Individual_Events.*' or Built-in",
        },
        'Max_Number_Reports': {
            'default': 1,
            'description': 'Used by reports and custom reports. The maximum number of report output files that will be produced for a given campaign.',
            'max': 1000000.0,
            'min': 0,
            'type': 'integer',
        },
        ...
        'Pretty_Format': {
            'default': 0,
            'description': 'True (1) sets pretty JSON formatting. The default, false (0), saves space.',
            'type': 'bool',
        },
        'Report_Description': {
            'default': 'UNINITIALIZED STRING',
            'description': 'Used by reports and custom reports. Augments the filename of the report. If multiple CSV reports are being generated, this allows you to distinguish among the multiple reports.',
            'type': 'string',
        },
        'Reporting_Interval': {
            'default': 1000000.0,
            'description': 'Used by reports and custom reports. Defines the cadence of the report by specifying how many time steps to collect data before writing to the file.',
            'max': 1000000.0,
            'min': 1,
            'type': 'float',
        },
    ...
    _validator = ClassValidator(_definition, 'MalariaImmunityReport')

    def __init__(self, Age_Bins=0, Duration_Days=3.40282e+38, Event_Trigger_List='', Max_Number_Reports=1, Nodeset_Config=None, Pretty_Format=False, Report_Description='UNINITIALIZED STRING', Reporting_Interval=1000000.0, Sim_Types=['MALARIA_SIM'], Start_Day=0, **kwargs):
        super(MalariaImmunityReport, self).__init__(**kwargs)
...
class MalariaPatientJSONReport(BaseCampaign):
    _definition = {
        'Sim_Types': ['MALARIA_SIM'],
        'class': 'MalariaPatientJSONReport',
    }
    _validator = ClassValidator(_definition, 'MalariaPatientJSONReport')

    def __init__(self, Sim_Types=['MALARIA_SIM'], **kwargs):
        super(MalariaPatientJSONReport, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types



class MalariaSqlReport(BaseCampaign):
    _definition = {
        'Sim_Types': ['MALARIA_SIM'],
        'class': 'MalariaSqlReport',
    }
    _validator = ClassValidator(_definition, 'MalariaSqlReport')

    def __init__(self, Sim_Types=['MALARIA_SIM'], **kwargs):
        super(MalariaSqlReport, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types



class MalariaSummaryReport(BaseCampaign):
    _definition = {
        'Age_Bins': {
            'ascending': 1,
            'default': 0,
        ...
        'Individual_Property_Filter': {
            'default': 'UNINITIALIZED STRING',
            'description': 'Individual property (and value) to filter on',
            'type': 'string',
        },
        'Infectiousness_Bins': {
            'ascending': 0,
            'default': 1,
            'description': 'Infectiousness Bins to aggregate within and report',
            'max': 3.40282e+38,
            'min': -3.40282e+38,
            'type': 'Vector Float',
        },
        ...
        'Parasitemia_Bins': {
            'ascending': 1,
            'default': 0,
            'description': 'Parasitemia Bins to aggregate within and report.  A value <= 0 in the first bin indicates that the uninfected people should be added to this bin.',
            'max': 3.40282e+38,
            'min': -3.40282e+38,
            'type': 'Vector Float',
        },
    ...
    _validator = ClassValidator(_definition, 'MalariaSummaryReport')

    def __init__(self, Age_Bins=0, Duration_Days=3.40282e+38, Event_Trigger_List='', Individual_Property_Filter='UNINITIALIZED STRING', Infectiousness_Bins=1, Max_Number_Reports=1, Nodeset_Config=None, Parasitemia_Bins=0, Pretty_Format=False, Report_Description='UNINITIALIZED STRING', Reporting_Interval=1000000.0, Sim_Types=['MALARIA_SIM'], Start_Day=0, **kwargs):
        super(MalariaSummaryReport, self).__init__(**kwargs)
        self.Age_Bins = Age_Bins
        self.Duration_Days = Duration_Days
        self.Event_Trigger_List = Event_Trigger_List
        self.Individual_Property_Filter = Individual_Property_Filter
        self.Infectiousness_Bins = Infectiousness_Bins
        self.Max_Number_Reports = Max_Number_Reports
        self.Nodeset_Config = Nodeset_Config
...
class MalariaSurveyJSONAnalyzer(BaseCampaign):
    _definition = {
        'Duration_Days': {
            'default': 3.40282e+38,
            'description': 'Used by reports and custom reports. The number of days over which to report events.',
        ...
        'IP_Key_To_Collect': {
            'default': '',
            'description': 'Name of the Individual Property Key whose value to collect.  Empty string means collect values for all IPs.',
            'type': 'string',
        },
        'Max_Number_Reports': {
            'default': 1,
    ...
    _validator = ClassValidator(_definition, 'MalariaSurveyJSONAnalyzer')

    def __init__(self, Duration_Days=3.40282e+38, Event_Trigger_List='', IP_Key_To_Collect='', Max_Number_Reports=1, Nodeset_Config=None, Pretty_Format=False, Report_Description='UNINITIALIZED STRING', Reporting_Interval=1000000.0, Sim_Types=['MALARIA_SIM'], Start_Day=0, **kwargs):
        super(MalariaSurveyJSONAnalyzer, self).__init__(**kwargs)
        self.Duration_Days = Duration_Days
        self.Event_Trigger_List = Event_Trigger_List
...
class MalariaTransmissionReport(BaseCampaign):
    _definition = {
        'Duration_Days': {
            'default': 3.40282e+38,
            'description': 'Used by reports and custom reports. The number of days over which to report events.',
        ...
        'Pretty_Format': {
            'default': 0,
            'description': 'True implies pretty JSON format, false saves space.',
            'type': 'bool',
        },
        'Report_Description': {
            'default': 'UNINITIALIZED STRING',
        ...
        'class': 'MalariaTransmissionReport',
    }
    _validator = ClassValidator(_definition, 'MalariaTransmissionReport')

    def __init__(self, Duration_Days=3.40282e+38, Event_Trigger_List='', Nodeset_Config=None, Pretty_Format=False, Report_Description='UNINITIALIZED STRING', Sim_Types=['MALARIA_SIM'], Start_Day=0, **kwargs):
        super(MalariaTransmissionReport, self).__init__(**kwargs)
        self.Duration_Days = Duration_Days
        self.Event_Trigger_List = Event_Trigger_List
        self.Nodeset_Config = Nodeset_Config
        self.Pretty_Format = Pretty_Format
...
class ReportDrugStatus(BaseCampaign):
    _definition = {
        'End_Day': {
            'default': 3.40282e+38,
            'description': 'Day to stop collecting data',
            'max': 3.40282e+38,
            'min': 0,
            'type': 'float',
        },
        ...
        'Start_Day': {
            'default': 0,
            'description': 'Day to start collecting data',
            'max': 3.40282e+38,
            'min': 0,
            'type': 'float',
        },
    ...
    _validator = ClassValidator(_definition, 'ReportDrugStatus')

    def __init__(self, End_Day=3.40282e+38, Sim_Types=['*'], Start_Day=0, **kwargs):
        super(ReportDrugStatus, self).__init__(**kwargs)
...
class ReportEventCounter(BaseCampaign):
    _definition = {
        'Duration_Days': {
            'default': 3.40282e+38,
            'description': 'Used by reports and custom reports. The number of days over which to report events.',
    ...
    _validator = ClassValidator(_definition, 'ReportEventCounter')

    def __init__(self, Duration_Days=3.40282e+38, Event_Trigger_List='', Nodeset_Config=None, Report_Description='UNINITIALIZED STRING', Sim_Types=['*'], Start_Day=0, **kwargs):
        super(ReportEventCounter, self).__init__(**kwargs)
        self.Duration_Days = Duration_Days
        self.Event_Trigger_List = Event_Trigger_List
        self.Nodeset_Config = Nodeset_Config
        self.Report_Description = Report_Description
...
class ReportHumanMigrationTracking(BaseCampaign):
    _definition = {
        'Sim_Types': ['*'],
        'class': 'ReportHumanMigrationTracking',
    }
    _validator = ClassValidator(_definition, 'ReportHumanMigrationTracking')

    def __init__(self, Sim_Types=['*'], **kwargs):
        super(ReportHumanMigrationTracking, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types



class ReportMalariaFiltered(BaseCampaign):
    _definition = {
        'End_Day': {
            'default': 3.40282e+38,
            'description': 'Day to stop collecting data',
        ...
        'Node_IDs_Of_Interest': {
            'default': 1,
            'description': 'Data will be collected for the nodes in tis list.',
            'max': 2147480000.0,
            'min': -2147480000.0,
            'type': 'Vector Int',
        },
        'Report_File_Name': {
            'default': 'ReportMalariaFiltered.json',
    ...
    _validator = ClassValidator(_definition, 'ReportMalariaFiltered')

    def __init__(self, End_Day=3.40282e+38, Node_IDs_Of_Interest=1, Report_File_Name='ReportMalariaFiltered.json', Sim_Types=['MALARIA_SIM'], Start_Day=0, **kwargs):
        super(ReportMalariaFiltered, self).__init__(**kwargs)
        self.End_Day = End_Day
        self.Node_IDs_Of_Interest = Node_IDs_Of_Interest
...
class ReportNodeDemographics(BaseCampaign):
    _definition = {
        'Age_Bins': {
            'ascending': 0,
            'default': 1,
            'description': 'Age Bins (in years) to aggregate within and report, empty array implies do not stratify by age',
            'max': 3.40282e+38,
            'min': -3.40282e+38,
            'type': 'Vector Float',
        },
        'IP_Key_To_Collect': {
            'default': '',
            'description': 'Name of the key to add a column for.',
            'type': 'string',
        },
        'Sim_Types': ['*'],
        'Stratify_By_Gender': {
            'default': 1,
            'description': '1 (default) implies stratify by gender, 0 implies do not',
            'type': 'bool',
        },
        'class': 'ReportNodeDemographics',
    }
    _validator = ClassValidator(_definition, 'ReportNodeDemographics')

    def __init__(self, Age_Bins=1, IP_Key_To_Collect='', Sim_Types=['*'], Stratify_By_Gender=True, **kwargs):
        super(ReportNodeDemographics, self).__init__(**kwargs)
        self.Age_Bins = Age_Bins
        self.IP_Key_To_Collect = IP_Key_To_Collect
        self.Sim_Types = Sim_Types
...
class ReportNodeDemographicsMalaria(BaseCampaign):
    _definition = {
        'Age_Bins': {
            'ascending': 0,
            'default': 1,
    ...
    _validator = ClassValidator(_definition, 'ReportNodeDemographicsMalaria')

    def __init__(self, Age_Bins=1, IP_Key_To_Collect='', Sim_Types=['MALARIA_SIM'], Stratify_By_Gender=True, **kwargs):
        super(ReportNodeDemographicsMalaria, self).__init__(**kwargs)
        self.Age_Bins = Age_Bins
        self.IP_Key_To_Collect = IP_Key_To_Collect
        self.Sim_Types = Sim_Types
        self.Stratify_By_Gender = Stratify_By_Gender
...
class ReportPluginAgeAtInfection(BaseCampaign):
    _definition = {
        'Sim_Types': ['*'],
        'class': 'ReportPluginAgeAtInfection',
    }
    _validator = ClassValidator(_definition, 'ReportPluginAgeAtInfection')

    def __init__(self, Sim_Types=['*'], **kwargs):
        super(ReportPluginAgeAtInfection, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types



class ReportPluginAgeAtInfectionHistogram(BaseCampaign):
    _definition = {
        'Age_At_Infection_Histogram_Report_Age_Bin_Upper_Edges_In_Years': {
            'ascending': 0,
            'default': 1,
            'description': 'TBD',
            'max': 3.40282e+38,
        ...
        'Age_At_Infection_Histogram_Report_Reporting_Interval_In_Years': {
            'default': 1,
            'description': 'TBD',
            'max': 3.40282e+38,
            'min': 0,
        ...
        'Sim_Types': ['*'],
        'class': 'ReportPluginAgeAtInfectionHistogram',
    }
    _validator = ClassValidator(_definition, 'ReportPluginAgeAtInfectionHistogram')

    def __init__(self, Age_At_Infection_Histogram_Report_Age_Bin_Upper_Edges_In_Years=1, Age_At_Infection_Histogram_Report_Reporting_Interval_In_Years=1, Sim_Types=['*'], **kwargs):
        super(ReportPluginAgeAtInfectionHistogram, self).__init__(**kwargs)
        self.Age_At_Infection_Histogram_Report_Age_Bin_Upper_Edges_In_Years = Age_At_Infection_Histogram_Report_Age_Bin_Upper_Edges_In_Years
        self.Age_At_Infection_Histogram_Report_Reporting_Interval_In_Years = Age_At_Infection_Histogram_Report_Reporting_Interval_In_Years
        self.Sim_Types = Sim_Types



class ReportRelationshipCensus(BaseCampaign):
    _definition = {
        'End_Year': {
            'default': 3.40282e+38,
            'description': 'Year to stop collecting data',
            'max': 3.40282e+38,
            'min': 0,
            'type': 'float',
        },
        'Report_File_Name': {
            'default': 'ReportRelationshipCensus.csv',
            'description': 'Name of the file to be written',
            'type': 'string',
        },
        'Reporting_Interval_Years': {
            'default': 1,
            'description': 'Years between census',
            'max': 100,
            'min': 0,
            'type': 'float',
        },
        ...
        'Start_Year': {
            'default': 0,
            'description': 'Year to start collecting data',
            'max': 3.40282e+38,
            'min': 0,
            'type': 'float',
        },
    ...
    _validator = ClassValidator(_definition, 'ReportRelationshipCensus')

    def __init__(self, End_Year=3.40282e+38, Report_File_Name='ReportRelationshipCensus.csv', Reporting_Interval_Years=1, Sim_Types=['STI_SIM', 'HIV_SIM'], Start_Year=0, **kwargs):
        super(ReportRelationshipCensus, self).__init__(**kwargs)
        self.End_Year = End_Year
        self.Report_File_Name = Report_File_Name
        self.Reporting_Interval_Years = Reporting_Interval_Years
        self.Sim_Types = Sim_Types
        self.Start_Year = Start_Year



class ReportRelationshipMigrationTracking(BaseCampaign):
    _definition = {
        'Sim_Types': ['STI_SIM', 'HIV_SIM'],
        'class': 'ReportRelationshipMigrationTracking',
    }
    _validator = ClassValidator(_definition, 'ReportRelationshipMigrationTracking')

    def __init__(self, Sim_Types=['STI_SIM', 'HIV_SIM'], **kwargs):
        super(ReportRelationshipMigrationTracking, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types



class ReportSimpleMalariaTransmissionJSON(BaseCampaign):
    _definition = {
        'Duration_Days': {
            'default': 3.40282e+38,
            'description': 'Used by reports and custom reports. The number of days over which to report events.',
    ...
    _validator = ClassValidator(_definition, 'ReportSimpleMalariaTransmissionJSON')

    def __init__(self, Duration_Days=3.40282e+38, Nodeset_Config=None, Pretty_Format=False, Report_Description='UNINITIALIZED STRING', Sim_Types=['MALARIA_SIM'], Start_Day=0, **kwargs):
        super(ReportSimpleMalariaTransmissionJSON, self).__init__(**kwargs)
        self.Duration_Days = Duration_Days
        self.Nodeset_Config = Nodeset_Config
        self.Pretty_Format = Pretty_Format
        self.Report_Description = Report_Description
...
class ReportVectorGenetics(BaseCampaign):
    _definition = {
        'Allele_Combinations_For_Stratification': {
            'depends-on': {
                'Stratify_By': 'ALLELE',
            },
            'description': 'If stratifying by allele, then also add these allele name combos to the stratification',
            'type': 'Vector 2d String',
        },
        'Combine_Similar_Genomes': {
            ...
            'description': '1 implies genomes are combined if for each locus (ignoring gender) the set of allele of the two genomes are the same (i.e. 1-0 is similar to 0-1).',
            'type': 'bool',
        },
        'Gender': {
            'default': 'VECTOR_FEMALE',
            'description': 'gender to include in file',
            'enum': ['VECTOR_FEMALE', 'VECTOR_MALE', 'VECTOR_BOTH_GENDERS'],
            'type': 'enum',
        },
        'Include_Vector_State_Columns': {
            'default': 1,
            'description': '1 implies to add the columns for vectors in the different states (i.e Eggs, Larva, etc).',
            'type': 'bool',
        },
        'Sim_Types': ['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'],
        'Species': {
            'default': 'UNINITIALIZED STRING',
            'description': 'The species to include information on.',
            'type': 'string',
        },
        'Specific_Genome_Combinations_For_Stratification': {
            ...
            'description': "If stratifying by SPECIFC_GENOME, then use these genomes to stratify by. '*' = list all entries at that location, '?' = combine all entries at that location",
            'RVG_AlleleCombo_Value': {
                'Allele_Combination': {
                    'description': "An array of array of strings that defines a genome.  Each value is an allele.  '*' is allowed to imply all.",
                    'type': 'Vector 2d String',
                },
            },
        },
        'Stratify_By': {
            'default': 'GENOME',
            'description': 'An enum that determines how the data is stratified',
            'enum': ['GENOME', 'SPECIFIC_GENOME', 'ALLELE'],
            'type': 'enum',
        },
        'class': 'ReportVectorGenetics',
    }
    _validator = ClassValidator(_definition, 'ReportVectorGenetics')

    def __init__(self, Allele_Combinations_For_Stratification=None, Combine_Similar_Genomes=False, Gender=ReportVectorGenetics_Gender_Enum.VECTOR_FEMALE, Include_Vector_State_Columns=True, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], Species='UNINITIALIZED STRING', Specific_Genome_Combinations_For_Stratification=None, Stratify_By=ReportVectorGenetics_Stratify_By_Enum.GENOME, **kwargs):
        super(ReportVectorGenetics, self).__init__(**kwargs)
        ...
        self.Gender = (Gender.name if isinstance(Gender, Enum) else Gender)
        ...
        self.Stratify_By = (Stratify_By.name if isinstance(Stratify_By, Enum) else Stratify_By)



class ReportVectorMigration(BaseCampaign):
    _definition = {
        'Sim_Types': ['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'],
        'class': 'ReportVectorMigration',
    }
    _validator = ClassValidator(_definition, 'ReportVectorMigration')

    def __init__(self, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], **kwargs):
        super(ReportVectorMigration, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types



class ReportVectorStats(BaseCampaign):
    _definition = {
        'Include_Gestation_Columns': {
            'default': 0,
            'description': 'Adds columns for feeding and gestation',
            'type': 'bool',
        },
        'Include_Wolbachia_Columns': {
            'default': 0,
            'description': 'Add a column for each type of Wolbachia.  Summation of columns should equal VectorPopulation.',
            'type': 'bool',
        },
        'Sim_Types': ['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'],
        'Species_List': {
        ...
        'Stratify_By_Species': {
            'default': 0,
            'description': 'If true data will break out each the species for each node',
            'type': 'bool',
        },
        'class': 'ReportVectorStats',
    }
    _validator = ClassValidator(_definition, 'ReportVectorStats')

    def __init__(self, Include_Gestation_Columns=False, Include_Wolbachia_Columns=False, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], Species_List=None, Stratify_By_Species=False, **kwargs):
        super(ReportVectorStats, self).__init__(**kwargs)
        self.Include_Gestation_Columns = Include_Gestation_Columns
        self.Include_Wolbachia_Columns = Include_Wolbachia_Columns
        self.Sim_Types = Sim_Types
...
class ReportVectorStatsMalaria(BaseCampaign):
    _definition = {
        'Include_Gestation_Columns': {
            'default': 0,
            'description': 'Adds columns for feeding and gestation',
        ...
        'class': 'ReportVectorStatsMalaria',
    }
    _validator = ClassValidator(_definition, 'ReportVectorStatsMalaria')

    def __init__(self, Include_Gestation_Columns=False, Include_Wolbachia_Columns=False, Sim_Types=['MALARIA_SIM'], Species_List=None, Stratify_By_Species=False, **kwargs):
        super(ReportVectorStatsMalaria, self).__init__(**kwargs)
        self.Include_Gestation_Columns = Include_Gestation_Columns
        self.Include_Wolbachia_Columns = Include_Wolbachia_Columns
        self.Sim_Types = Sim_Types
        self.Species_List = Species_List
...
class Report_TBHIV_Basic(BaseCampaign):
    _definition = {
        'Sim_Types': ['TBHIV_SIM'],
        'Start_Year': {
            'default': 0,
        ...
        'class': 'Report_TBHIV_Basic',
    }
    _validator = ClassValidator(_definition, 'Report_TBHIV_Basic')

    def __init__(self, Sim_Types=['TBHIV_SIM'], Start_Year=0, Stop_Year=2200, **kwargs):
        super(Report_TBHIV_Basic, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types
        self.Start_Year = Start_Year
...
class Report_TBHIV_ByAge(BaseCampaign):
    _definition = {
        'Additional_Events': {
            'description': 'Additional Events to Record',
            'type': 'Vector String',
        },
        'Max_Age_Yrs': {
            'default': 200,
            'description': 'Maximum age to collect data',
            'max': 200,
            'min': 0,
            'type': 'float',
        },
        'Min_Age_Yrs': {
            'default': 0,
            'description': 'Minimum age to aollect data',
            'max': 200,
            'min': 0,
            'type': 'float',
        },
        ...
        'class': 'Report_TBHIV_ByAge',
    }
    _validator = ClassValidator(_definition, 'Report_TBHIV_ByAge')

    def __init__(self, Additional_Events=None, Max_Age_Yrs=200, Min_Age_Yrs=0, Sim_Types=['TBHIV_SIM'], Start_Year=0, Stop_Year=2200, **kwargs):
        super(Report_TBHIV_ByAge, self).__init__(**kwargs)
...
class SpatialReportMalariaFiltered(BaseCampaign):
    _definition = {
        'End_Day': {
            'default': 3.40282e+38,
            'description': 'Day to stop collecting data',
        ...
        'Report_File_Name': {
            'default': 'SpatialReportMalariaFiltered.json',
            'description': 'Name of the file to be written',
            'type': 'string',
        },
        'Reporting_Interval': {
            'default': 1,
            'description': 'Number of days to collect data and average over.',
            'max': 3.40282e+38,
            'min': 0,
            'type': 'float',
        },
        ...
        'Spatial_Output_Channels': {
            'default': [],
            'description': 'An array of channel names for spatial output by node and time step. The data from each channel will be written to a separate binary file. For full documentation of spatial output channels, please see the online documentation.',
            'possible_values': {
                'type': 'list',
                'item_type': {
                    'type': 'object',
    ...
    _validator = ClassValidator(_definition, 'SpatialReportMalariaFiltered')

    def __init__(self, End_Day=3.40282e+38, Node_IDs_Of_Interest=1, Report_File_Name='SpatialReportMalariaFiltered.json', Reporting_Interval=1, Sim_Types=['MALARIA_SIM'], Spatial_Output_Channels=[], Start_Day=0, **kwargs):
        super(SpatialReportMalariaFiltered, self).__init__(**kwargs)
        self.End_Day = End_Day
        self.Node_IDs_Of_Interest = Node_IDs_Of_Interest
        self.Report_File_Name = Report_File_Name
        self.Reporting_Interval = Reporting_Interval
        self.Sim_Types = Sim_Types
        self.Spatial_Output_Channels = Spatial_Output_Channels
        self.Start_Day = Start_Day



class VectorHabitatReport(BaseCampaign):
    _definition = {
        'Sim_Types': ['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'],
        'class': 'VectorHabitatReport',
    }
    _validator = ClassValidator(_definition, 'VectorHabitatReport')

    def __init__(self, Sim_Types=['VECTOR_SIM', 'MALARIA_SIM', 'DENGUE_SIM'], **kwargs):
        super(VectorHabitatReport, self).__init__(**kwargs)
        self.Sim_Types = Sim_Types
