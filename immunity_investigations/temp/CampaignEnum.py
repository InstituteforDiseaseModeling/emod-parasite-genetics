...
class Action_Value_Event_Type_Enum(Enum):
    INDIVIDUAL = auto()
    NODE = auto()
    COORDINATOR = auto()
...
class Incidence_Counter_Counter_Event_Type_Enum(Enum):
    INDIVIDUAL = auto()
    NODE = auto()
    COORDINATOR = auto()


class Incidence_Counter_Counter_Type_Enum(Enum):
    PERIODIC = auto()
...
class MalariaDiagnostic_Diagnostic_Type_Enum(Enum):
    BLOOD_SMEAR_PARASITES = auto()
    BLOOD_SMEAR_GAMETOCYTES = auto()
    PCR_PARASITES = auto()
    PCR_GAMETOCYTES = auto()
    PF_HRP2 = auto()
    TRUE_PARASITE_DENSITY = auto()
    FEVER = auto()
...
class MultiInsecticideUsageDependentBednet_Expiration_Period_Distribution_Enum(
    Enum):
    NOT_INITIALIZED = auto()
    CONSTANT_DISTRIBUTION = auto()
    UNIFORM_DISTRIBUTION = auto()
...
class StandardDiagnostic_Event_Or_Config_Enum(Enum):
    Config = auto()
    Event = auto()
...
class LarvalHabitatMultiplierSpec_Value_Habitat_Enum(Enum):
...
class MosquitoRelease_Released_Wolbachia_Enum(Enum):
    VECTOR_WOLBACHIA_FREE = auto()
    VECTOR_WOLBACHIA_A = auto()
    VECTOR_WOLBACHIA_B = auto()
    VECTOR_WOLBACHIA_AB = auto()


class MultiInsecticideSpaceSpraying_Spray_Kill_Target_Enum(Enum):
...
class SugarTrap_Expiration_Distribution_Enum(Enum):
    NOT_INITIALIZED = auto()
    CONSTANT_DISTRIBUTION = auto()
    UNIFORM_DISTRIBUTION = auto()
    GAUSSIAN_DISTRIBUTION = auto()
...
class ReportVectorGenetics_Gender_Enum(Enum):
    VECTOR_FEMALE = auto()
    VECTOR_MALE = auto()
    VECTOR_BOTH_GENDERS = auto()


class ReportVectorGenetics_Stratify_By_Enum(Enum):
    GENOME = auto()
    SPECIFIC_GENOME = auto()
    ALLELE = auto()


class VectorGeneDriver_Value_Driver_Type_Enum(Enum):
    CLASSIC = auto()
    INTEGRAL_AUTONOMOUS = auto()


class VectorSpeciesParameters_Value_Vector_Sugar_Feeding_Frequency_Enum(Enum):
    VECTOR_SUGAR_FEEDING_NONE = auto()
    VECTOR_SUGAR_FEEDING_ON_EMERGENCE_ONLY = auto()
    VECTOR_SUGAR_FEEDING_EVERY_FEED = auto()
    VECTOR_SUGAR_FEEDING_EVERY_DAY = auto()
