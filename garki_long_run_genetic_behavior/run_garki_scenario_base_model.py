...
exp_name = 'FPG_epi_validity_base_model'
# Setup ----------------------------------------------------------------------------------------------------------
# config_path = os.path.join('.', 'inputs','config.json')
# cb = DTKConfigBuilder.from_files(config_path)
cb = DTKConfigBuilder.from_files(config_name ='C:\git\emod-parasite-genetics\garki_immune_variation_exploration\inputs\config.json', campaign_name="C:\git\emod-parasite-genetics\garki_immune_variation_exploration\inputs\campaign_Base.json")

# cb = DTKConfigBuilder.from_defaults('MALARIA_SIM')

cb.update_params({
    "Demographics_Filenames": ["Garki_single_demographics.json"],
    "Campaign_Filename": "campaign_Base.json",
    ...
    "Parasite_Genetics": {
        ...
        "Var_Gene_Randomness_Type": "FIXED_MSP",
